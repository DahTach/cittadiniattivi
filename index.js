...
window.onload = () => {
  ...
  function chiSiamoList() {
    ...
    for (i = 0; i < arrayLength; i++) {
      ...
      temp.innerHTML = `
            <li class="flex lg:gap-x-2 flex-row justify-center align-center lg:justify-start ">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="hidden w-4 h-auto lg:block flex-none" aria-hidden="true">
